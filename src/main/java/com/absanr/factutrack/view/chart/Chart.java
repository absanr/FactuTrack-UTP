...
public class Chart extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        blankPlotChart = new com.absanr.factutrack.view.chart.BlankPlotChart();

        panelLegend.setOpaque(false);
        panelLegend.setLayout(new java.awt.FlowLayout(1, 5, 0));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(blankPlotChart, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
                .addGap(40, 40, 40))
        );
    }// </editor-fold>//GEN-END:initComponents

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private com.absanr.factutrack.view.chart.BlankPlotChart blankPlotChart;
